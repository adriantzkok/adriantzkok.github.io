    ...
    <div className="max-w-6xl mx-auto">
      ...
      >
        <div className="relative">
          ...
          <div
            ref={scrollRef}
            className="flex items-start space-x-8 min-w-[700px] md:min-w-0 md:justify-center md:space-x-12 relative z-10 overflow-x-auto [scrollbar-width:none] [-ms-overflow-style:none]"
          >
