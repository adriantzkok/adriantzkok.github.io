...
export const PROJECTS: Project[] = [
  ...
  },
  {
    ...
    longDescription:
      "One of my first personal projects, MarkBlog, was born out of my desire to share my academic learnings in a space that I could own and have full control over. aving used Notion prior to this, it was a great learning experience for me to understand how full stack applications are built and managed. This project was a significant learning experience for me, as it involved me building my first full-stack application from scratch.",
    technologies: [
      "Supabase",
      "Vue.js",
      "Javascript",
    ...
    timeline: "3 months",
    impact: [
      "Implemented Filtering and Pagination from initiativescratch for API optimisation",
